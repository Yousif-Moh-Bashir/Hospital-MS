...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('dashboard/Services_trans.Services')}}</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('dashboard/GroupServices_trans.Insurance_companies')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('insurance_companies.update','test')}}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="insurance_code" value="{{$insurance->insurance_code}}" class="form-control @error('insurance_code') is-invalid @enderror">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="name" value="{{$insurance->name}}" class="form-control @error('name') is-invalid @enderror">
                                @error('name')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label>{{trans('dashboard/GroupServices_trans.discoun_value')}} %</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                &nbsp;
                                <input name="status" {{$insurance->status == 1 ? 'checked' : ''}} value="1" type="checkbox" class="form-check-input" id="exampleCheck1" style="margin-left: 0.2rem;">
                            </div>
                        </div>
