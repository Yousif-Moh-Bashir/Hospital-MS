										...
										<div class="main-signup-header">
											...
											<form action="{{ route('register.user') }}" method="POST">
												...
												<div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Enter your firstname and lastname" type="text" name="name" autofocus>
                                                    @error('name')
												...
												<div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Enter your password" type="password" name="password" autofocus autocomplete="new-password">
                                                    @error('password')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
												</div>
												<div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Enter your password" type="password" name="password_confirmation" autofocus>
