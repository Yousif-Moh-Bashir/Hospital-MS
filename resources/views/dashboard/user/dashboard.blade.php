...
@section('css')
<!--  Owl-carousel css-->
<link href="{{asset('dashbord/plugins/owl-carousel/owl.carousel.css')}}" rel="stylesheet" />
<!-- Maps css -->
<link href="{{asset('dashbord/plugins/jqvmap/jqvmap.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
								...
								<div class="list-group list-lg-group list-group-flush">
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{asset('dashbord/img/faces/3.jpg')}}" alt="Image description">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{asset('dashbord/img/faces/11.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{asset('dashbord/img/faces/17.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{asset('dashbord/img/faces/15.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
									...
									<div class="list-group-item list-group-item-action br-br-7 br-bl-7" href="#">
										<div class="media mt-0">
											<img class="avatar-lg rounded-circle ml-3 my-auto" src="{{asset('dashbord/img/faces/6.jpg')}}" alt="Image description">
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
...
<!--Internal  Flot js-->
<script src="{{asset('dashbord/plugins/jquery.flot/jquery.flot.js')}}"></script>
<script src="{{asset('dashbord/plugins/jquery.flot/jquery.flot.pie.js')}}"></script>
<script src="{{asset('dashbord/plugins/jquery.flot/jquery.flot.resize.js')}}"></script>
<script src="{{asset('dashbord/plugins/jquery.flot/jquery.flot.categories.js')}}"></script>
<script src="{{asset('dashbord/js/dashboard.sampledata.js')}}"></script>
<script src="{{asset('dashbord/js/chart.flot.sampledata.js')}}"></script>
<!--Internal Apexchart js-->
<script src="{{asset('dashbord/js/apexcharts.js')}}"></script>
<!-- Internal Map -->
...
<script src="{{asset('dashbord/js/modal-popup.js')}}"></script>
<!--Internal  index js -->
<script src="{{asset('dashbord/js/index.js')}}"></script>
<script src="{{asset('dashbord/js/jquery.vmap.sampledata.js')}}"></script>
@endsection
