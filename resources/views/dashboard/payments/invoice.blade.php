                                        ...
                                        <div class="invoice-inner clearfix">
                                            <div class="invoice-info clearfix" id="invoice_wrapper">
                                                ...
                                                <div class="invoice-top border-shadow-bg">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <h1 class="invoice-name">{{ trans('dashboard/Payment.Catch_Payment') }}</h1>
                                                        </div>
                                                        <div class="col-sm-6 mb-30">
                                                            <div class="invoice-number-inner">
                                                                <h2 class="name">{{ trans('dashboard/Payment.Invoice_No') }} : {{ $payment_account->id }}</h2>
                                                                <p class="mb-0">{{ trans('dashboard/Payment.Invoice_Date') }} : <span>{{ $payment_account->created_at->isoFormat('MMM Do YYYY') }}</span></p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 mb-30">
                                                            <div class="invoice-number">
                                                                <h4 class="inv-title-1">{{ trans('dashboard/Payment.Invoice_To') }}</h4>
                                                                <h2 class="name mb-10">{{ $payment_account->patient->name }}</h2>
                                                                <p class="invo-addr-1 mb-0">
                                                                    {{ $payment_account->patient->email }} <br/>
                                                                    {{ $payment_account->patient->Address }} <br/>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 mb-30">
